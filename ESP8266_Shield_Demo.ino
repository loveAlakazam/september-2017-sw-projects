/*
이 소스코드는 최종 소스코드가 아닙니다.
최종소스코드가 포맷으로 인해 손실되어 SparkfunESP8266의 AP모드를 일부 코드와 
HTML 파일만 남아서, 남아있는 소스코드만이라도 깃허브의 september-2017-sw-projects repository에 올리기로했습니다.
*/
/************************************************************
